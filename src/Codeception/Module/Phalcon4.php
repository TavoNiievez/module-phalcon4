...
class Phalcon4 extends Framework implements ActiveRecord, PartedModule
{
     ...
     */
    protected function findRecord(string $model, array $attributes = []): PhalconModel
    {
     ...
     */
    protected function findRecords(string $model, array $attributes = []): ResultsetInterface
    {
        $this->getModelRecord($model);
        $conditions = [];
        $bind       = [];
     ...
     * @throws ModuleException
     */
    protected function getModelRecord($model): PhalconModel
    {
